...
U_raw = np.array([
    [0.2109+0.4077j, 0.0582-0.6129j, -0.0306-0.0966j, 0.1638+0.6103j],
    [-0.6817+0.5319j, -0.2335+0.1715j, -0.0690-0.0395j, 0.4004-0.0425j],
    [0.0795+0.1160j, -0.3216+0.25723j, 0.7731+0.3231j, -0.1189+0.3074j],
    [-0.1254-0.0784j, 0.4136-0.4431j, 0.4785+0.2279j, 0.3809-0.4299j]
], dtype=complex)
