...
U_raw = np.array([
    [-0.1621+0.2429j, 0.4073+0.6121j, 0.4713-0.2842j, 0.0488+0.2626j],
    [0.3262+0.4577j, -0.4901-0.1377j, 0.2527-0.0627j, 0.5493+0.2355j],
    [-0.4460+0.1968j, -0.3531-0.1724j, 0.1236-0.6339j, -0.2267-0.3734j],
    [-0.5004-0.3330j, -0.1408+0.1615j, -0.4257-0.1757j, 0.5296+0.3166j]
], dtype=complex)
